...
begin
	with n do begin
		writeln ('|CODIGO: ',cod,'|GENERO: ',gen,'|NOMBRE: ',nom,'|DURACION: ',
                    dur,' |DIRECTOR: ',dir,'|PRECIO: ',precio:0:2);
		writeln ('');
	end;
end;
...
begin
	...
	writeln ('');
	case opcion of 
	1: begin write ('INGRESE NUEVO PRECIO: '); readln (n.precio); end;
	2: begin write ('INGRESE NUEVO GENERO: '); readln (n.gen); end;
	3: begin write ('INGRESE NUEVO NOMBRE: '); readln (n.nom); end;
	4: begin write ('INGRESE NUEVO DIRECTOR: '); readln (n.dir); end;
	5: begin write ('INGRESE NUEVA DURACION: '); readln (n.dUr); end;
	else 
...
begin
	...
	while (n.cod <> valorAlto) do begin
		with n do begin
			if (cod > 0) then
				writeln (arcTxt,'CODIGO: ',cod,' NOMBRE: ',nom,' GENERO: ',
                        gen,' DIRECTOR: ',dir,' DURACION: ',dur,' PRECIO: ',precio:1:1)
			else
...
begin
	...
	while (loop) do begin
		writeln ('');
		write ('SI INGRESA CUALQUIER CARACTER SE DESPLEGARA NUEVAMENTE EL MENU.',
                ' SI INGRESA E SE CERRARA LA CONSOLA: ');
        readln (letra);
